...
class MisoRepository {
    companion object {
        ...
        {
            val callGetDetailForecast = TransportManager.getRetrofitApiObject<ForecastDetailResponseDto>()
        ...
        {
            val callGetSurveyMyAnswers = TransportManager.getRetrofitApiObject<SurveyMyAnswerResponseDto>()
        ...
        {
            val callPutSurveyMyAnswer = TransportManager.getRetrofitApiObject<SurveyAddMyAnswerResponseDto>()
